...
// + Soporta: horario encendido/apagado, phases, captura de foto tras cambio luz, publicación en /status
...
void takeAndSendPhoto() {
  ...
  String topic = "gh-mqtt/" + String(device_id) + "/photo";
  client.publish(topic.c_str(), fb->buf, fb->len);
